...
class AvlTree
	{
	 private:
        ...
        BinaryNode<ItemType>* insert(BinaryNode<ItemType> *rootPtr, BinaryNode<ItemType> *newPtr, bool& taller) throw(DuplicateErr);
...
template <class ItemType>
BinaryNode<ItemType>*  AvlTree<ItemType>::insert(BinaryNode<ItemType> *rootPtr, BinaryNode<ItemType> *newPtr, bool& taller) throw (DuplicateErr)
{
    //	Statements
    if (rootPtr == nullptr)
    {
